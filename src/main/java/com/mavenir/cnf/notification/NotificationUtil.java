...
public class NotificationUtil {
	...
	public static void sendEvent(String eventName, ArrayList<KeyValueBean> managedObjects) throws Exception {
		sendEvent(eventName, null, managedObjects, null, null, null);
	}
	...
	public static void sendEvent(String eventName, ArrayList<KeyValueBean> additionalInfo,
			...
			ArrayList<KeyValueBean> stateChangeDefinition, ArrayList<KeyValueBean> monitoredAttributes)
			throws Exception {
		...
		builder.clear();
		LOG.info(Constants.ACTIVITY + Constants.EVENT + "Publishing event: " + eventName + " to NATS");
		publishEvent(buffer);
	}
